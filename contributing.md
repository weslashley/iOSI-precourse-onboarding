...
Our community has grown tremendously, and our students and instructors do a lot to adapt materials, correct bugs, and enhance this curriculum as they prepare for the classroom.  For this reason, if you have the time, we ask that you contribute your work back to the master repository and use the documentation below as a guide.

Included in this file is information about:

- [iOS-precourse-onboarding GitHub Community](#the-community)
