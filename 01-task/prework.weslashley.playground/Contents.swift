...
if age >= 21 && canDrink == true {
    print("You're old enough to vote, drink and drive a car! But don't drink and drive!")
} else if age >= 18 && age <= 20 && canVote == true {
    print("You're old enough to vote and drive a car!")
} else if age >= 16 && age <= 17 && canDrive == true {
    print("You're old enough to drive a car!")
} else {
    print("You're not old enough to do any of the things!")
}

// TODO: When you're done, set it equal to 18. Do this with only 'if' statements (do not use 'else' or 'else if').
/*var age = 18
var canDrive = "true", canVote = "true", canDrink = "false"
if age >= 16 && age <= 17 && canDrive == "true" {
    print("You're old enough to drive a car!")
}; if age >= 18 && age <= 20 && canVote == "true" {
    print("You're old enough to vote and drive a car!")
}; if age >= 21 && canDrink == "true" {
    print("You're old enough to vote, drink and drive a car! But don't drink and drive!")
}; if age <= 15 {
